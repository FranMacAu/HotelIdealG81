...
public class TipoHabitaciónView extends javax.swing.JFrame {

public TipoHabitaciónView () {
    initComponents();
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoHabitaciónView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoHabitaciónView().setVisible(true);
            }
        });
    }
